...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team and play in competitive matches",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["ryan@mergington.edu", "lily@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Develop basketball skills with drills and scrimmages",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["taylor@mergington.edu", "harper@mergington.edu"]
    },
    "Art Club": {
